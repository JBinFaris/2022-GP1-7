                        ...
                        actions: <Widget>[
                           TextButton(
                                    ...
                                    TextButton(
                                      ...
                                      onPressed: () async {
                                       _firestore.collection("foodPost").doc("${widget.snap["docId"].toString()}").delete();
                           ...
                           TextButton(
                                    ...
                                    TextButton(
                                      ...
                                      onPressed: () async {
                                          ...
                                          _firestore.collection("foodPost").doc(widget.snap["docId"].toString()).update({"reserve": "0"});
              ...
              style: const TextStyle(
                ...
                fontWeight: FontWeight.bold,
                  ...
                  Align(
                    alignment: Alignment.centerRight,
                    child:  Text(
            ///   ( " البريد الإلكتروني للحاجز : ${usrEmail!}"),
